define(function(require){
  ...
  utils.api.get = function(url, data, callback){
    utils.ajax('get', config.baseUrl + url, data, callback);
  };

  utils.api.post = function(url, data, callback){
    utils.ajax('post', config.baseUrl + url, data, callback);
  };

  utils.api.patch = function(url, data, callback){
    utils.ajax('patch', config.baseUrl + url, data, callback);
  };
  ...
  utils.api.del = function(url, data, callback){
    utils.api.request('del', config.baseUrl + url, data, callback);
  };
