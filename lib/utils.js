define(function(require){
  ...
  utils.api.get = function(url, data, callback){
    return utils.get(config.apiUrl + url, data, callback);
  };

  utils.api.post = function(url, data, callback){
    return utils.post(config.apiUrl + url, data, callback);
  };

  utils.api.patch = function(url, data, callback){
    return utils.put(config.apiUrl + url, data, callback);
  };
  ...
  utils.api.del = function(url, data, callback){
    return utils.del(config.apiUrl + url, data, callback);
  };
