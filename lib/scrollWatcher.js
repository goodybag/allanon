define(['troller', 'utils'], function(troller, utils) {
  ...
  var startNearEnd = function() {
    utils.dom(document).on('resize', setupNearEnd);
    utils.dom(document).on('resize', destroyNearEnd);
  ...
  var stopNearEnd = function() {
    utils.dom(document).off('resize', setupNearEnd);
    utils.dom(document).off('resize', destroyNearEnd);
