define(['troller', 'backbone', 'underscore'], function(troller, Backbone, _) {
  var watchedPositions = {};
  var scrollWatcher = {};
  _.extend(scrollWatcher, Backbone.Events);
  ...
  var scrollHandler = function() {
    ...
    for (pos in watchedPositions) {
      if (isInView(pos) !== watchedPositions[pos]) {
        (watchedPositions[pos] ? enteredView : leftView).push(pos);
