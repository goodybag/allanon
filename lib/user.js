define(function(require){
  ...
  // TODO: if we don't store the other stuff on the attributes, we don't need to filter them before returning
  , toJSON: function(){
      return utils.pick(this.attributes, ['id', 'email', 'firstName', 'lastName', 'screenName', 'cardId', 'avatarUrl']);
    }
