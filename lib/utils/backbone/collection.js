define(function(require) {
  ...
  var Collection = Backbone.Collection.extend({
    ...
    nextPage: function(options) {
      ...
      options = options || {};
      if (this.fetchedLastPage) return typeof options.complete === 'function' ? options.complete() : null;
      var coll = this;
      ...
      options = _.extend(options, {
        ...
        success: function(collection, response, opts) {
          coll.fetchedLastPage = response.length < coll.pageSize;
          coll.page++;
          if (!options.silent) {
    ...
    set: function(models, options) {
      ...
      if (options.reset || !models) return;
      var added = [];
      var any = false;
    ...
    initialize: function(models, options) {
      ...
      this.queryParams = _.extend(_.clone(this.queryParams), options.queryParams || {});
    }
  });
